(function() {
  var exports, htmlDecode, htmlEncode, parseParams, parseUrl, replaceEmoji;

  htmlEncode = function(e) {
    return e.replace(/&/g, "&amp;").replace(RegExp(" ", "g"), "&nbsp;").replace(/</g, "&lt;").replace(/>/g, "&gt;").replace(/\n/g, "<br />").replace(/"/g, "&quot;");
  };
  ...
  parseUrl = function(e) {
    var n, t;
    t = new RegExp("(http[s]{0,1}|ftp)://([a-zA-Z0-9\\.\\-]+\\.[a-zA-Z]{2,4})(:\\d+)?(/[a-zA-Z0-9\\.\\-~!@#$%^&amp;*+:_/<>]*)?([\\?a-zA-Z0-9\\.\\-~!@$%^&amp;*+?:_/<>=]*)?(#\\w+)?");
    n = e.match(t);
    if (n != null) {
      return {
        protocol: n[1],
