  ...
  module.exports = function(grunt) {
    ...
    grunt.initConfig({
      ...
      rev: {
        dist: {
          files: {
            src: ['<%= flynavi.dist %>/{,*/}*.js', '!<%= flynavi.dist %>/*.js', '<%= flynavi.dist %>/{,*/}*.css', '<%= flynavi.dist %>/{,*/}*.{png,jpg,jpeg,gif}', '!<%= flynavi.dist %>/images/{positionLight,bg_loading,bg_positiong_no,cur_position}.png']
          }
        }
      },
      useminPrepare: {
      ...
      uncss: {
        dist: {
          ...
          files: {
            "dist/styles/combination.css": ["app/start.html"]
          }
        }
      },
      csscss: {
      ...
      manifest: {
        ...
        generate: {
          ...
          src: ["**/*.{css,png,jpg,jpeg,gif}", 'combination.js', 'flynavi/app/model/route-view.js', 'scripts/model/pathDrawing.js', 'flynavi/app/model/networkCommunication-raxtone.js', 'flynavi/app/controller/controller_navControl.js', 'flynavi/app/controller/controller_toolbar.js'],
      ...
      'gh-pages': {
        ...
        src: ["**/*", "!node_modules/**/*", "!dist/**/*", '!app/bower_components']
      }
    });
